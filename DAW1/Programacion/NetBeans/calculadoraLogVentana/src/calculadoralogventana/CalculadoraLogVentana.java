...
public class CalculadoraLogVentana extends Application {
    ...
    private void solucion() {
        ...
        try {
            BufferedWriter fichero = new BufferedWriter(new FileWriter("C:\\Users\\zx21student278\\Desktop\\Datos\\fichero.log", true));
